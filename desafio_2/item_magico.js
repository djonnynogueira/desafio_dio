...
// Cria o objeto ItemMagicoPersonalizado com base no tipo escolhido
if (tipoItem === 'arma') {
    itemPersonalizado = new ItemMagicoPersonalizado(tipoItem, danoItem, resistenciaItem, efeitoEspecial);
  } else {
